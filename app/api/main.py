...
from app.api.routes import group_routes, auth_routes, member_routes, course_routes, professor_routes
...
api_router.include_router(professor_routes.router, tags=["Professor"])
